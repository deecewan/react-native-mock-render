  ...
  _renderChildren() {
    ...
    this.props.sections.forEach((item, index) => {
      if (this.props.renderSectionHeader) {
        r.push(this.props.renderSectionHeader({ section: item }));
      }
      const renderFunction = item.renderItem || this.props.renderItem;
      r.push(...item.data.map((d, i) => renderFunction({
        item: d,
        index: i,
        section: item,
        separators: {
      ...
      if (this.props.renderSectionFooter) {
        r.push(this.props.renderSectionFooter({ section: item }));
      }
    });
    return r;
  },
